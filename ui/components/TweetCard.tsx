...
export function TweetCard({ tweet }: TweetCardProps) {
  ...
  return (
    <article className="border-b border-blue-200 px-3 py-3 dark:border-blue-800 sm:px-4 sm:py-4">
      <div className="flex flex-col gap-2 sm:gap-3">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <time
            ...
            className="shrink-0 text-sm text-blue-500 dark:text-blue-400"
          >
            {formattedDate}
          </time>
        </div>
        ...
        {/* Tweet Text */}
        <p className="whitespace-pre-wrap break-words text-[15px] leading-relaxed text-blue-800 dark:text-blue-200 sm:text-base">
          {tweet.text}
        </p>
