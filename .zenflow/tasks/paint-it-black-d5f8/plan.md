...
The PRD for this work is located in {@artifacts_path},
where first line of the PRD contains the branch name of the current base branch. grep by the name of the base branch. 
...
<!-- chat-id: 83323c8f-6883-46c9-a3ae-69ab413006ba -->
